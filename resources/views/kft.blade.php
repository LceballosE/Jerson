...
<div  class="bgded overlay" style="background-image:url('images/expanciones/kft.jpg');">
<div class="wrapper row2">
  ...
  <div class="jumbotron" style="background-color: black; opacity: 0.6;border-radius: 20px;padding: 30px;margin: 20px" >
    <h6 class="heading font-x3" style="text-align: center;">Hielo y muerte</h6>
          <p style="text-align: center;" > Encuentra Todo lo que necesitas para ser el mejor.</p>
          <p style="text-align: center"> En un nuevo mundo donde los muertos mandan</p>
</div>
</div>
