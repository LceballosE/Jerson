  ...
  <main class="hoc container clear">
    ...
    <div class="group">
      <div class="one_half first">
        ...
        <h6 class="heading font-x2" style="text-align: center">La naturaleza es tu aliado</h6>
        <p>Es el archidruida más grande que jamás haya vivido y uno de los mortales más poderosos del universo Warcraft. Su poder de héroe es el "Cambio de forma" el cual otorga al héroe 1 punto de blindaje y además, 1 punto de ataque ese turno.</p>
        
      </div>
    </div>

      <div class="one_half" style="text-align: center" >
        <img src="images/mazos/druidahp.png" style="width:53%; height:auto"   >
      </div>
      </div>
  </main>
</div>
