...
<div  class="bgded overlay" style="background-image:url('images/demo/heroes.jpg');">
      ...
      <ul class="clear">
        ...
        <ul>
           <li><a href="/descripcionheroe">Descripción Básica</a></li>
             ...
             <li><a href="/tiposheroes">tipos heroes</a></li>
             <li><a href="/#">otro</a></li>
  ...
  <div style="color: white">
        <div class="jumbotron" style="background-color: black; opacity: 0.5; padding: 50px; border-radius: 20px">
          <h6 class="heading font-x3" style="text-align: center;">Elige un héroe </h6>
          <p style="text-align: center">Conoce todas las opciones que tienes para ser el mejor. Ellos te van a ayudar</p>
        </div>
      </div>
      </div>
</div>
